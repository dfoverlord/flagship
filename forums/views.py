...
class TopicListView(ListView):
    ...
    template_name = 'forum_topics.html'
    paginate_by = 20
...
class PostListView(ListView):
    ...
    template_name = 'forum_topic_posts.html'
    paginate_by = 20
...
def new_topic(request, pk):
    ...
    if request.method == 'POST':
        ...
        form = NewTopicForm()
    return render(request, 'new_forum_topic.html', {'forum': forum, 'form': form})
...
def reply_topic(request, pk, topic_pk):
    ...
    if request.method == 'POST':
        ...
        form = PostForm()
    return render(request, 'reply_forum_topic.html', {'topic': topic, 'form': form})
