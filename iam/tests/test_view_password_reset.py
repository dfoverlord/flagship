...
class PasswordResetTests(TestCase):
    def setUp(self):
        url = reverse('pages:password_reset')
...
class SuccessfulPasswordResetTests(TestCase):
    ...
    def test_redirection(self):
        url = reverse('pages:password_reset_done')
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('pages:password_reset_confirm', kwargs={'uidb64': self.uid, 'token': self.token})
...
class InvalidPasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        url = reverse('pages:password_reset_confirm', kwargs={'uidb64': uid, 'token': token})
        self.response = self.client.get(url)
    ...
    def test_html(self):
        password_reset_url = reverse('pages:password_reset')
...
class PasswordResetCompleteTests(TestCase):
    def setUp(self):
        url = reverse('pages:password_reset_complete')
        self.response = self.client.get(url)
